      ...
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(images/slider/1.jpg)">
          <div class="caption">
            ...
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="view.jsp">Book now</a>
          </div>
        </div>
    ...
    <div class="main-nav">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="view.jsp">
            <h1><img class="img-responsive" src="images/logo.png" alt="logo"></h1>
          </a>                    
        </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            <li class="scroll"><a href="view.jsp">Book an event</a></li>                     
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
	<form id="login-form" action="OrderController" method="post" role="form" style="display: block;">
									<div class="form-group" >

<p style="color:Black">Event Managers:</p>
...
<%
String id = request.getParameter("ManagerName");
...
String sql ="SELECT managerName FROM emanagers";
...
<option><%= resultSet.getString("managerName")%></option>
 <% } %>
</select>
<% 
} catch (Exception e) {
...
%>
 ...
 <div class="form-group">
<font color="white">Events:<input type="checkbox" name="event" value="1">Wedding</font><br>
       <font color="white"><ul><input type="checkbox" name="event" value="2"> Birthday's</font></ul></ul>
       <font color="white"><ul><input type="checkbox" name="event" value="3">Baby showers</font></ul>
       <font color="white"><ul><input type="checkbox" name="event" value="4">Corporate Events</font></ul>
       <font color="white"> <ul><input type="checkbox" name="event" value="5">Educational Events</font></ul>
       <font color="white"><ul><input type="checkbox" name="event" value="6">Exibitions</font></ul>
       <font color="white"><ul><input type="checkbox" name="event" value="7">Concerts</font></ul>
</div>
